...
public:
    ...
    void setupUi(QWidget *LocalSet)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(20, 50, 291, 51));
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(20, 100, 291, 51));
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(0, 150, 311, 51));
        ...
        label_13->setGeometry(QRect(10, 50, 91, 49));
